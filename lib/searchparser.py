...
The original code can be found here: https://github.com/laramies/theHarvester
"""
...
class Parser:
    """Parse search results to extract email addresses and social media profiles."""
    ...
    def __init__(self, results, word):
        ...
        **Parameters**
        ...
        ``results``
            Results from a harvester.py module to search
        ``word``
