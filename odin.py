...
def osint(self, client, domain, dns, google, files, scope_file, verbose):
	"""
...
@click.option('-o', '--output', default="Shodan_Report.xlsx", help="Name of the output file for the information.")
